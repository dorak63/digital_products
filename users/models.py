...
from django.contrib.auth.models import AbstractBaseUser, PermissionsMixin, BaseUserManager, send_mail, Permission, Group
...
class User(AbstractBaseUser, PermissionsMixin):
    groups = models.ManyToManyField(Group, verbose_name=_('groups'), blank=True, related_name='user_set')
    user_permissions = models.ManyToManyField(Permission,
                                              related_name='users_user_permissions')  # Existing or modified name
    """
