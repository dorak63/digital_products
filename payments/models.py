...
class Gateway(models.Model):
    ...
    is_enable = models.DateTimeField(_('is enable'), default=True)
...
class Payment(models.Model):
    ...
    package = models.ForeignKey('subscriptions.Package', verbose_name='package', related_name='%(class)s',
    ...
    phone_number = models.BigIntegerField(_('creation time'), validators=[validate_phone_number], db_index=True)
    consumed_code = models.PositiveIntegerField(_('consumed reference code'), null=True, db_index=True)
    create_time = models.DateTimeField(_('creation time'), auto_now_add=True, db_index=True)
