    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.CharField(db_index=True, max_length=20, validators=[utils.validators.SKUValidator()], verbose_name='stack kipping unit')),
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('avatar', models.ImageField(blank=True, upload_to='packages/', verbose_name='avatar')),
                ('is_enable', models.DateTimeField(default=True, verbose_name='is_enable')),
